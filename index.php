...
<div class="alert alert-danger alert-transtion" role="alert">

    <h3> HOLKOFF AKCE  </h3>
    <span> 7.4.-9.4.2023 </span>

</div>

<div class="background-row">
    <div class="content row">
        <div class="col-sm facts">

            <div class="facts-item fact-girls">
            ...
            <div class="facts-item facts-actions">
                <div class="fact-number">
                    3
                </div>
                <div class="fact-note">
            ...
            <div class="facts-item facts-ext">
                <div class="fact-number">
                    100%
                </div>
                <div class="fact-note">
...
<div class="content">
    <div class="calendar" id="calendar">
        <img src="img/velikonoce.jpg" alt="" class="tmp-easter">
    </div>
...
<div class="content">
    ...
    margin-bottom: 1em;">FOTOGALERIE</h1>
</div>
...
<footer class="text-center text-lg-start bg-light text-muted" id="footer">
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
        ...
        <div class="me-5 d-none d-lg-block">
            <span>JAK SE S NÁMI SPOJIT:</span>
        </div>
        <!-- Left -->
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
        © 2023 Copyright: Daniela Zedníčková
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->
